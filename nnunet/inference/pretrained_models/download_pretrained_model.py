...
def get_available_models():
    available_models = {
        ...
        "Task076_Fluo_N3DH_SIM": {
            'description': "Fluo-N3DH-SIM model of the cell tracking challenge. Segmentation target are N3DH cells and cell borders in fluorescence microscopy images.\n"
                           "input modalities are 0: fluorescence_microscopy\n"
                           "Also see http://celltrackingchallenge.net/\n",
        ...
        "Task089_Fluo-N2DH-SIM_thickborder_time": {
            'description': "Fluo-N2DH-SIM model of the cell tracking challenge. Segmentation target are nuclei of N2DH cells and cell borders in fluorescence microscopy images.\n"
...
def print_license_warning():
    ...
    print('!!!!!!!!!!!!!!!!!!!!!!!!WARNING!!!!!!!!!!!!!!!!!!!!!!!')
    print('######################################################')
    print("Using the pretrained model weights is subject to the license of the model they were trained on. Some "
          "allow commercial use, others don't. It is your responsibility to make sure you use them appropriately! Use "
          "nnUNet_print_pretrained_model_info(task_name) to see a summary of the model and where to find its license!")
    print('######################################################')
    print('')
