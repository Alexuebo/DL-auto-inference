...
base = "/media/alex/linux-data/XB/nnUNet/nnUNet_raw_data_base"
preprocessing_output_dir = "/media/alex/linux-data/XB/nnUNet/nnUNet_preprocessed"
network_training_output_dir_base = "/media/alex/linux-data/XB/nnUNet/nnUNet_trained_models"

"""
PLEASE READ paths.md FOR INFORMATION TO HOW TO SET THIS UP
"""

# base = os.environ['nnUNet_raw_data_base'] if "nnUNet_raw_data_base" in os.environ.keys() else raw_base
# base = raw_base
# preprocessing_output_dir = os.environ['nnUNet_preprocessed'] if "nnUNet_preprocessed" in os.environ.keys() else processdir
# network_training_output_dir_base = os.path.join(os.environ['RESULTS_FOLDER']) if "RESULTS_FOLDER" in os.environ.keys() else outputdir
