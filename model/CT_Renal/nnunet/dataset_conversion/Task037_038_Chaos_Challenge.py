...
def convert_variant2_predicted_test_to_submission_format(folder_with_predictions,
    ...
    from model.CT_Renal.nnunet.postprocessing import apply_postprocessing_to_folder, load_postprocessing
...
if __name__ == "__main__":
    ...
    supposed to train all organs. This would require manual modification of nnU-net to deal with this model. This is 
    ...
    save_json(json_dict, join(output_folder, "model.json"))
