...
from model.CT_Renal.nnunet.configuration import default_num_threads, RESAMPLING_SEPARATE_Z_ANISO_THRESHOLD
...
class GenericPreprocessor(object):
    ...
    def run(self, target_spacings, input_folder_with_cropped_npz, output_folder, data_identifier,
        ...
        # we need to know which classes are present in this model so that we can precompute where these classes are
