...
class DatasetAnalyzer(object):
    def __init__(self, folder_with_cropped_data, overwrite=True, num_processes=default_num_threads):
        ...
        assert isfile(join(self.folder_with_cropped_data, "model.json")), \
            "model.json needs to be in folder_with_cropped_data"
    ...
    def get_classes(self):
        datasetjson = load_json(join(self.folder_with_cropped_data, "model.json"))
