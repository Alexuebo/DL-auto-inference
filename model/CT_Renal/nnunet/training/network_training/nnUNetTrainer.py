...
from model.CT_Renal.nnunet.training.dataloading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from nnunet.training.loss_functions.dice_loss import DC_and_CE_loss
from model.CT_Renal.nnunet.training.network_training import NetworkTrainer
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if training:
            ...
            if self.unpack_data:
                self.print_to_log_file("unpacking model")
